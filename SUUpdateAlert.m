...
{
  id hasobj = [host objectForKey:SUAllowsSkipThisVersionKey];
  BOOL val = hasobj ? [host boolForUserDefaultsKey:SUAllowsSkipThisVersionKey] : YES;
  NSLog(@"%@ is %s", SUAllowsSkipThisVersionKey, (val?"YES":"NO"));
  return val;
}
